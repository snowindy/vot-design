...
<div id="content">
    <div class="content-cell"  id="home">
        <h2>Дизайн-студия</h2>
    ...
    <div class="content-cell" id="service">
        <h2>Услуги</h2>
  ...
  <p>&nbsp;</p>-->
    ...
    <div class="content-cell has-text" id="contacts">
    ...
    <div class="content-cell has-text" id="portfolio">
